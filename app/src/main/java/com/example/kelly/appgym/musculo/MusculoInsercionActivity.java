...
public class MusculoInsercionActivity extends AppCompatActivity {
    ...
    void attemptGuardar(){
        ...
        Musculo musculo = new Musculo(G.SIN_VALOR_INT, nombre);
        MusculoProveedor.insert(getContentResolver(), musculo, this);
        finish();
    }
}
