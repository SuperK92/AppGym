...
public class ActividadActualizacionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actividadId = this.getIntent().getExtras().getInt("ID");

        int idEjercicio = this.getIntent().getExtras().getInt("Id_Ejercicio");
        int series = this.getIntent().getExtras().getInt("Series");
        int repeticiones = this.getIntent().getExtras().getInt("Repeticiones");

        editTextActividadEjercicio.setText(String.valueOf(idEjercicio));
        editTextActividadSeries.setText(String.valueOf(series));
        editTextActividadRepeticiones.setText(String.valueOf(repeticiones));
    ...
    void attemptGuardar(){
        ...
        Actividad actividad = new Actividad(actividadId, ejercicio, series, repeticiones);
        ActividadProveedor.update(getContentResolver(), actividad, this);
